      ...
      <div className="bg-slate-700 rounded-lg shadow-sm border border-slate-600 overflow-hidden">
        <div className="px-6 py-8 sm:px-8 sm:py-12">
          ...
          <div className="prose prose-lg prose-slate max-w-none">
            <div className="grid">
              <section>
                <h2 className="text-2xl font-semibold text-slate-100 mb-2">Who I Am</h2>
              ...
              <section>
                <h2 className="text-2xl font-semibold text-slate-100 mb-2">What I Do</h2>
                <p className="text-slate-300 leading-relaxed mb-4">
              ...
              <section>
                <h2 className="text-2xl font-semibold text-slate-100 mb-2">Why I Write</h2>
                <p className="text-slate-300 leading-relaxed">
              ...
              <section>
                <h2 className="text-2xl font-semibold text-slate-100 mb-2">My Education</h2>
                <p className="text-slate-300 leading-relaxed mb-4">
                  I completed the UK's Eduqual Level 6 Diploma in AIOps from Al Nafi International College, a globally recognized program that's changing careers worldwide. This diploma is:
                </p>
                <ul className="list-none space-y-2 text-slate-300 ml-0 mb-4">
              ...
              <section>
                ...
                <div className="flex flex-wrap gap-4">
                  <a
                    ...
                    className="inline-flex items-center px-4 py-2 border border-slate-600 rounded-md text-sm font-medium text-slate-300 bg-slate-700 hover:bg-slate-500 transition-colors"
                  >
