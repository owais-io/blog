    ...
    >
      <nav className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden md:flex md:items-center md:space-x-1 absolute left-1/2 transform -translate-x-1/2">
            {navItems.map((item) => (
              <Link
                key={item.href}
                href={item.href}
        ...
        >
          <div className="px-2 pt-2 pb-3 space-y-1 border-t border-gray-200 dark:border-gray-700 bg-white/50 dark:bg-gray-900/50 backdrop-blur-sm rounded-b-lg">
            ...
            <div className="flex justify-center space-x-6 px-4 py-3 border-t border-gray-200 dark:border-gray-700">
              <a
                href="https://linkedin.com/in/owais-io"
                target="_blank"
                rel="noopener noreferrer"
