...
export default function SponsorAd() {
  return (
    <div className="sponsor-ad-wrapper my-6">
      <div className="sponsor-ad bg-gradient-to-br from-slate-800 via-slate-800 to-slate-700 rounded-xl border-2 border-cyan-600 p-6 shadow-xl hover:shadow-2xl transition-all duration-300">
        <div className="flex flex-col items-center text-center">
          {/* Sponsor Badge */}
          <div className="text-xs font-semibold text-cyan-400 uppercase tracking-wider mb-3 bg-cyan-900/50 px-3 py-1 rounded-full">
            Sponsored
          </div>
          ...
          <div className="flex flex-wrap gap-2 justify-center mb-5 text-xs">
            <span className="bg-gradient-to-r from-purple-900/50 to-blue-900/50 text-purple-300 px-3 py-1 rounded-full font-medium">🤖 AI</span>
            <span className="bg-gradient-to-r from-blue-900/50 to-cyan-900/50 text-blue-300 px-3 py-1 rounded-full font-medium">⚙️ DevOps</span>
            <span className="bg-gradient-to-r from-red-900/50 to-orange-900/50 text-red-300 px-3 py-1 rounded-full font-medium">🔒 Cyber Security</span>
            <span className="bg-gradient-to-r from-green-900/50 to-emerald-900/50 text-green-300 px-3 py-1 rounded-full font-medium">☁️ Cloud</span>
            <span className="bg-gradient-to-r from-indigo-900/50 to-blue-900/50 text-indigo-300 px-3 py-1 rounded-full font-medium">🛡️ Offensive Security</span>
            <span className="bg-gradient-to-r from-yellow-900/50 to-amber-900/50 text-yellow-300 px-3 py-1 rounded-full font-medium">⛓️ Blockchain</span>
          </div>

          {/* Key Benefits - Compact version */}
          <div className="bg-slate-600/50 rounded-lg p-4 mb-5 w-full backdrop-blur-sm">
            <ul className="text-sm text-left text-slate-300 space-y-2.5">
          ...
          {/* Urgency message */}
          <div className="bg-gradient-to-r from-yellow-900/30 to-orange-900/30 border border-yellow-600 rounded-lg p-3 mb-4">
