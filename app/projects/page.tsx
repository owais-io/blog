  ...
  return (
    <div className="max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-16">
        {projects.map((project) => (
          <div
            ...
            className="bg-slate-700 rounded-lg border border-slate-600 overflow-hidden cursor-pointer hover:shadow-lg hover:border-cyan-500 transition-all duration-200 transform hover:-translate-y-1"
          >
            {/* Card Header */}
            <div className="p-6">
              <div className="flex items-start justify-between mb-3">
                <h2 className="text-xl font-semibold text-slate-100 line-clamp-2 flex-1">
                  {project.title}
                </h2>
                <span
              ...
              <div className="flex flex-wrap gap-1.5 mb-4">
                {project.technologies.slice(0, 3).map((tech) => (
                  <span
                    key={tech}
                    className="inline-flex items-center px-2 py-0.5 rounded text-xs font-medium bg-cyan-900/50 text-cyan-300"
                  >
                    {tech}
                  </span>
                ))}
      ...
      {selectedProject && (
        ...
        >
          <div
            className="bg-slate-700 rounded-lg max-w-4xl w-full max-h-[90vh] overflow-y-auto"
            onClick={(e) => e.stopPropagation()}
          >
            {/* Modal Header */}
            <div className="sticky top-0 bg-slate-700 border-b border-slate-600 p-6 flex items-start justify-between">
            ...
            <div className="p-6">
              ...
              {selectedProject.highlights && selectedProject.highlights.length > 0 && (
                <div className="mb-6">
                  <h3 className="text-sm font-semibold text-slate-100 mb-3">Key Highlights</h3>
              ...
              {/* Technologies */}
              <div className="mb-6">
                <h3 className="text-sm font-semibold text-slate-100 mb-3">Technologies Used</h3>
              ...
              <div className="flex items-center gap-4 pt-4 border-t border-slate-600">
                {selectedProject.githubUrl && (
                  <a
                    ...
                    className="inline-flex items-center px-4 py-2 border border-slate-600 text-sm font-medium rounded-md text-slate-300 bg-slate-700 hover:bg-slate-500 transition-colors"
                  >
        ...
        <div className="bg-slate-700 rounded-lg p-8">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center px-6 py-3 border border-slate-600 text-base font-medium rounded-md text-slate-300 bg-slate-700 hover:bg-slate-500 transition-colors"
            >
              View GitHub
            </a>
          </div>
