        ...
        <div className="px-6 py-8 sm:px-8 sm:py-12">
          ...
          <div className="prose prose-lg prose-slate max-w-none space-y-8">
            ...
            <section>
              ...
              <h3 className="text-xl font-semibold text-slate-100 mb-3 mt-6">Personal Information</h3>
              ...
              <h3 className="text-xl font-semibold text-slate-100 mb-3 mt-6">Automatically Collected Information</h3>
              <p className="text-slate-300 leading-relaxed mb-4">
            ...
            <section>
              <h2 className="text-2xl font-semibold text-slate-100 mb-4">Cookies and Tracking Technologies</h2>
              <p className="text-slate-300 leading-relaxed mb-4">
              ...
              <h3 className="text-xl font-semibold text-slate-100 mb-3 mt-6">Types of Cookies We Use</h3>
              <ul className="list-disc list-inside space-y-2 text-slate-300 ml-4">
            ...
            <section>
              ...
              <h3 className="text-xl font-semibold text-slate-100 mb-3 mt-6">Google Analytics</h3>
              <p className="text-slate-300 leading-relaxed mb-4">
              ...
              <h3 className="text-xl font-semibold text-slate-100 mb-3 mt-6">Google AdSense</h3>
              <p className="text-slate-300 leading-relaxed mb-4">
              ...
              <h3 className="text-xl font-semibold text-slate-100 mb-3 mt-6">Other Third-Party Services</h3>
              <p className="text-slate-300 leading-relaxed">
            ...
            <section>
              <h2 className="text-2xl font-semibold text-slate-100 mb-4">Your Data Protection Rights</h2>
              <p className="text-slate-300 leading-relaxed mb-4">
            ...
            <section>
              <h2 className="text-2xl font-semibold text-slate-100 mb-4">Links to Other Websites</h2>
              <p className="text-slate-300 leading-relaxed">
            ...
            <section className="border-t border-slate-600 pt-8 mt-8">
              <h2 className="text-2xl font-semibold text-slate-100 mb-4">GDPR Compliance</h2>
              <p className="text-slate-300 leading-relaxed mb-4">
            ...
            <section>
              <h2 className="text-2xl font-semibold text-slate-100 mb-4">California Privacy Rights (CCPA)</h2>
              <p className="text-slate-300 leading-relaxed mb-4">
