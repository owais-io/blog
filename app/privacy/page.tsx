    ...
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 overflow-hidden">
        <div className="px-6 py-8 sm:px-8 sm:py-12">
          ...
          {/* Content sections */}
          <div className="prose prose-lg prose-gray dark:prose-invert max-w-none space-y-8">
            ...
            <section>
              ...
              <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-3 mt-6">Google Analytics</h3>
              <p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-4">
              ...
              <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-3 mt-6">Google AdSense</h3>
              <p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-4">
              ...
              <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-3 mt-6">Other Third-Party Services</h3>
              <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
            ...
            <section>
              <h2 className="text-2xl font-semibold text-gray-900 dark:text-white mb-4">Your Data Protection Rights</h2>
              <p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-4">
            ...
            <section>
              <h2 className="text-2xl font-semibold text-gray-900 dark:text-white mb-4">Links to Other Websites</h2>
              <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
            ...
            <section className="border-t border-gray-200 dark:border-gray-700 pt-8 mt-8">
              <h2 className="text-2xl font-semibold text-gray-900 dark:text-white mb-4">GDPR Compliance</h2>
              <p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-4">
            ...
            <section>
              <h2 className="text-2xl font-semibold text-gray-900 dark:text-white mb-4">California Privacy Rights (CCPA)</h2>
              <p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-4">
