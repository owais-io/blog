  ...
  <table className="min-w-full border-collapse border border-gray-300">
    <thead>
      <tr className="bg-gray-100">
        ...
        <th className="border border-gray-300 px-4 py-2">How to Enter</th>
      </tr>
    </thead>
    <tbody>
      <tr>
        <td className="border border-gray-300 px-4 py-2"><strong>Normal</strong></td>
        <td className="border border-gray-300 px-4 py-2">Navigate and execute commands</td>
        <td className="border border-gray-300 px-4 py-2">Press <code>Esc</code> (default mode when vim opens)</td>
      </tr>
      <tr>
        <td className="border border-gray-300 px-4 py-2"><strong>Insert</strong></td>
        <td className="border border-gray-300 px-4 py-2">Type and edit text</td>
        <td className="border border-gray-300 px-4 py-2">Press <code>i</code>, <code>a</code>, <code>o</code>, <code>O</code> from Normal mode</td>
      </tr>
      <tr>
        <td className="border border-gray-300 px-4 py-2"><strong>Visual</strong></td>
        <td className="border border-gray-300 px-4 py-2">Select text</td>
        <td className="border border-gray-300 px-4 py-2">Press <code>v</code>, <code>V</code>, <code>Ctrl+v</code> from Normal mode</td>
      </tr>
      <tr>
        <td className="border border-gray-300 px-4 py-2"><strong>Command-line</strong></td>
        <td className="border border-gray-300 px-4 py-2">Execute commands (save, quit, search)</td>
        <td className="border border-gray-300 px-4 py-2">Press <code>:</code>, <code>/</code>, <code>?</code> from Normal mode</td>
      </tr>
    </tbody>
  </table>
</div>
  ...
  <table className="min-w-full border-collapse border border-gray-300">
    ...
    <tbody>
      <tr>
        ...
        <td className="border border-gray-300 px-4 py-2">Insert before cursor</td>
      </tr>
      <tr>
        <td className="border border-gray-300 px-4 py-2"><code>a</code></td>
        <td className="border border-gray-300 px-4 py-2">Insert <strong>a</strong>fter cursor</td>
      </tr>
      <tr>
        <td className="border border-gray-300 px-4 py-2"><code>I</code></td>
        <td className="border border-gray-300 px-4 py-2">Insert at beginning of line</td>
      </tr>
      <tr>
        <td className="border border-gray-300 px-4 py-2"><code>A</code></td>
        <td className="border border-gray-300 px-4 py-2">Insert at end of line</td>
      </tr>
      <tr>
        <td className="border border-gray-300 px-4 py-2"><code>o</code></td>
        <td className="border border-gray-300 px-4 py-2"><strong>O</strong>pen new line below</td>
      </tr>
      <tr>
        <td className="border border-gray-300 px-4 py-2"><code>O</code></td>
        <td className="border border-gray-300 px-4 py-2"><strong>O</strong>pen new line above</td>
      </tr>
    </tbody>
  </table>
</div>
  ...
  <table className="min-w-full border-collapse border border-gray-300">
    ...
    <tbody>
      <tr>
        ...
        <td className="border border-gray-300 px-4 py-2">Delete character under cursor</td>
      </tr>
      <tr>
        <td className="border border-gray-300 px-4 py-2"><code>X</code></td>
        <td className="border border-gray-300 px-4 py-2">Delete character before cursor</td>
      </tr>
      <tr>
        <td className="border border-gray-300 px-4 py-2"><code>dd</code></td>
        <td className="border border-gray-300 px-4 py-2">Delete entire line</td>
      </tr>
      <tr>
        <td className="border border-gray-300 px-4 py-2"><code>dw</code></td>
        <td className="border border-gray-300 px-4 py-2">Delete word</td>
      </tr>
      <tr>
        <td className="border border-gray-300 px-4 py-2"><code>d$</code></td>
        <td className="border border-gray-300 px-4 py-2">Delete from cursor to end of line</td>
      </tr>
      <tr>
        <td className="border border-gray-300 px-4 py-2"><code>d0</code></td>
        <td className="border border-gray-300 px-4 py-2">Delete from cursor to beginning of line</td>
      </tr>
    </tbody>
  </table>
</div>
...
<div className="overflow-x-auto">
  <table className="min-w-full border-collapse border border-gray-300">
    ...
    <tbody>
      <tr>
        <td className="border border-gray-300 px-4 py-2"><code>yy</code></td>
        <td className="border border-gray-300 px-4 py-2">Yank (copy) entire line</td>
      </tr>
      <tr>
        <td className="border border-gray-300 px-4 py-2"><code>yw</code></td>
        <td className="border border-gray-300 px-4 py-2">Yank word</td>
      </tr>
      <tr>
        <td className="border border-gray-300 px-4 py-2"><code>p</code></td>
        <td className="border border-gray-300 px-4 py-2">Put (paste) after cursor</td>
      </tr>
      <tr>
        <td className="border border-gray-300 px-4 py-2"><code>P</code></td>
        <td className="border border-gray-300 px-4 py-2">Put (paste) before cursor</td>
      </tr>
    </tbody>
  </table>
</div>
