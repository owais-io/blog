  ...
  <table className="min-w-full border-collapse border border-gray-300">
    <thead>
      <tr className="bg-gray-100">
        ...
        <th className="border border-gray-300 px-4 py-2">WinSCP</th>
        <th className="border border-gray-300 px-4 py-2">FileZilla</th>
        <th className="border border-gray-300 px-4 py-2">MobaXterm SFTP</th>
        <th className="border border-gray-300 px-4 py-2">Windows Explorer</th>
      </tr>
    </thead>
    <tbody>
      <tr>
        <td className="border border-gray-300 px-4 py-2"><strong>SFTP Support</strong></td>
      ...
      <tr>
        <td className="border border-gray-300 px-4 py-2"><strong>Directory Sync</strong></td>
      ...
      <tr>
        <td className="border border-gray-300 px-4 py-2"><strong>Dual-Pane View</strong></td>
        <td className="border border-gray-300 px-4 py-2">✅</td>
        <td className="border border-gray-300 px-4 py-2">✅</td>
        <td className="border border-gray-300 px-4 py-2">✅</td>
        <td className="border border-gray-300 px-4 py-2">❌</td>
      ...
      <tr>
        <td className="border border-gray-300 px-4 py-2"><strong>Scripting</strong></td>
        <td className="border border-gray-300 px-4 py-2">✅ Powerful</td>
        <td className="border border-gray-300 px-4 py-2">❌ Weak</td>
        <td className="border border-gray-300 px-4 py-2">✅</td>
        <td className="border border-gray-300 px-4 py-2">❌</td>
      </tr>
      <tr>
        <td className="border border-gray-300 px-4 py-2"><strong>Integrated Editor</strong></td>
        <td className="border border-gray-300 px-4 py-2">✅</td>
        <td className="border border-gray-300 px-4 py-2">✅</td>
        <td className="border border-gray-300 px-4 py-2">✅</td>
      ...
      <tr>
        <td className="border border-gray-300 px-4 py-2"><strong>SSH Keys</strong></td>
        <td className="border border-gray-300 px-4 py-2">✅ .ppk</td>
        <td className="border border-gray-300 px-4 py-2">✅ OpenSSH</td>
        <td className="border border-gray-300 px-4 py-2">✅</td>
        <td className="border border-gray-300 px-4 py-2">N/A</td>
      </tr>
      <tr>
      ...
      <tr>
        <td className="border border-gray-300 px-4 py-2"><strong>Platform</strong></td>
      ...
      <tr>
        <td className="border border-gray-300 px-4 py-2"><strong>Terminal</strong></td>
        <td className="border border-gray-300 px-4 py-2">❌</td>
        <td className="border border-gray-300 px-4 py-2">❌</td>
        <td className="border border-gray-300 px-4 py-2">✅</td>
        <td className="border border-gray-300 px-4 py-2">N/A</td>
