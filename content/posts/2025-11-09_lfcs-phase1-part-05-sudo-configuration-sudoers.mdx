...
⚠️ **NEVER EDIT /etc/sudoers DIRECTLY!** Always use `visudo` command. Editing directly can lock you out of sudo access if you make a syntax error!
</Callout>
  ...
  <table className="min-w-full border-collapse border border-gray-300 dark:border-gray-700">
    ...
    <tbody>
      <tr className="hover:bg-gray-50 dark:hover:bg-gray-800">
        ...
        <td className="border border-gray-300 dark:border-gray-700 px-4 py-2">✅ Yes - validates before saving</td>
        <td className="border border-gray-300 dark:border-gray-700 px-4 py-2">❌ No - can save broken file</td>
      </tr>
      <tr className="hover:bg-gray-50 dark:hover:bg-gray-800">
        <td className="border border-gray-300 dark:border-gray-700 px-4 py-2"><strong>File Locking</strong></td>
        <td className="border border-gray-300 dark:border-gray-700 px-4 py-2">✅ Yes - prevents concurrent edits</td>
        <td className="border border-gray-300 dark:border-gray-700 px-4 py-2">❌ No - race conditions possible</td>
      </tr>
      <tr className="hover:bg-gray-50 dark:hover:bg-gray-800">
        <td className="border border-gray-300 dark:border-gray-700 px-4 py-2"><strong>Error Recovery</strong></td>
        <td className="border border-gray-300 dark:border-gray-700 px-4 py-2">✅ Options to fix or revert</td>
        <td className="border border-gray-300 dark:border-gray-700 px-4 py-2">❌ May lose sudo access entirely</td>
      </tr>
      <tr className="hover:bg-gray-50 dark:hover:bg-gray-800">
        <td className="border border-gray-300 dark:border-gray-700 px-4 py-2"><strong>Safety</strong></td>
        <td className="border border-gray-300 dark:border-gray-700 px-4 py-2">✅ Can't save invalid file</td>
        <td className="border border-gray-300 dark:border-gray-700 px-4 py-2">❌ Can break sudo completely</td>
      </tr>
    </tbody>
  </table>
</div>
...
✅ **Always choose (e)dit** if there's an error! Never choose (Q)uit - that would save the broken file and lock you out of sudo!
</Callout>
...
<Callout type="info">
💡 **Important**: Always use absolute paths for commands in sudoers. Use `which command` to find the full path.
</Callout>
...
<Callout type="warning">
⚠️ **LFCS Critical Concept**: Always restrict `passwd root` when granting passwd privileges. This is a common exam scenario!
</Callout>
...
**What this allows:**
- ✅ Change passwords for regular users
- ✅ Create new users
- ✅ Modify user properties
- ❌ Change root password (blocked!)
...
<Callout type="success">
🎉 **Congratulations!** You've completed Part 5 of the LFCS Certification series. You now understand how to safely configure sudo, grant specific permissions, and create secure privilege policies.
