...
<div className="grid grid-cols-1 md:grid-cols-2 gap-6 my-8">
  <div className="bg-white dark:bg-gray-800 p-6 rounded-lg border-2 border-blue-300 dark:border-blue-700">
    ...
    <ul className="space-y-2 text-sm">
      <li>✓ Used by regular users</li>
      <li>✓ Don't usually need root</li>
      <li>✓ Examples: ls, grep, cat, vi</li>
  ...
  <div className="bg-white dark:bg-gray-800 p-6 rounded-lg border-2 border-red-300 dark:border-red-700">
    ...
    <ul className="space-y-2 text-sm">
      <li>✓ Used by system admins</li>
      <li>✓ Usually require root/sudo</li>
      <li>✓ Examples: fdisk, useradd, systemctl</li>
...
<Callout type="info">
💡 **Key Concept**: When you run a program, Linux automatically loads the required libraries from `/usr/lib64` (or `/usr/lib`). This is why updating a library can affect many programs at once!
</Callout>
...
<Callout type="info">
💡 **Why This Order**: `/usr/local` comes first so your manually installed versions take precedence over system packages!
</Callout>
...
<div className="my-8 p-6 bg-gradient-to-r from-green-50 to-emerald-50 dark:from-green-900/20 dark:to-emerald-900/20 rounded-lg border-2 border-green-200 dark:border-green-800">
  ...
  <ul className="space-y-2 text-gray-700 dark:text-gray-300">
    <li><strong>✓ /usr</strong>: Unix System Resources - where most software lives</li>
    <li><strong>✓ /usr/bin</strong>: User commands (ls, grep, vim) - 1000+ programs</li>
    <li><strong>✓ /usr/sbin</strong>: System administration binaries (fdisk, systemctl)</li>
    <li><strong>✓ /usr/lib64</strong>: Shared libraries used by programs</li>
    <li><strong>✓ /usr/share</strong>: Documentation, man pages, icons, themes</li>
    <li><strong>✓ /usr/local</strong>: Locally installed software (not from package manager)</li>
    <li><strong>✓ Modern systems</strong>: /bin and /sbin are symlinks to /usr/bin and /usr/sbin</li>
    <li><strong>✓ Read-only</strong>: /usr is often read-only in production for security</li>
    <li><strong>✓ Package managers</strong>: Install software to /usr automatically</li>
    <li><strong>✓ Custom software</strong>: Always use /usr/local, never modify /usr directly</li>
  </ul>
</div>
...
**Series Navigation:**
- ← Previous: [Part 17 - Understanding Linux Filesystem Hierarchy Overview](/blog/2025-12-07_lfcs-phase1-part-17-filesystem-hierarchy-overview)
